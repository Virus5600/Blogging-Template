...
$(document).ready(function() {
	...
	$(".image-input-scope .image-input input[type=text]").on("change, keyup", function(e) {
		...
		if (obj.val().length == 0) {
			...
			$(obj.attr('data-target-image-container')).attr('onerror', `this.src="/uploads/users/default.png";$(this).removeAttr('onerror');`);
		}
	});
	...
	setTimeout(() => {$(".image-input-scope .image-input input[type=file]").trigger('change')}, 500);
});