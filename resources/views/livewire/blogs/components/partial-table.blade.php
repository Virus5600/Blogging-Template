<div class="container-fluid blogging partial-table">
		...
		<div class="card w-lg-75 mx-auto my-3">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-5">
						{{-- POSTER IMAGE --}}
						<img src="{{ $b->getPoster() }}" alt="{{ $b->title }}" class="img img-fluid img-thumbnail enlarge-on-hover cursor-pointer" draggable="false" data-toggle="modal" data-target="#{{ $b->slug }}">
