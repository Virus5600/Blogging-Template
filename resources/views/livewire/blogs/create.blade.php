		...
		<div class="row">
			...
			<div class="col-12 col-lg-6">
				...
				<div class="form-group text-counter-parent">
					...
					<textarea rows="4" class="form-control not-resizable text-counter-input" wire:model.lazy="summary" data-max="255"></textarea>
				...
				<div class="form-group my-auto">
					<div class="custom-control custom-switch custom-switch-md">
						<input type="checkbox" class="custom-control-input" id="is-draft" wire:model.lazy="is_draft">
