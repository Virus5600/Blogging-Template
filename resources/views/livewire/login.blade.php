...
<div class="card w-100 w-sm-75 w-md-50 w-lg-25 m-auto">
	...
	<form class="card-body" wire:submit.prevent="authenticate">
		...
		<div class="form-group">
			...
			<input class="form-control border-secondary" type="text" name="username" value="{{ old('username') }}" aria-label="Username" placeholder="Username" wire:model="username" />
		</div>

		<div class="form-group">
			<label class="form-label" for="password">Password</label>
			<div class="input-group">
				<input class="form-control border-secondary border-right-0" type="password" name="password" id="password" aria-label="Password" aria-describedby="toggle-show-password" placeholder="Password" wire:model="password" />
