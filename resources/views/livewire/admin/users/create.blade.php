							...
							<div class="image-input-scope" id="avatar-scope" data-settings="#image-input-settings" data-fallback-img="{{ $settings["default-avatar"] }}">
								...
								<div class="form-group text-center image-input collapse show avatar_holder" id="avatar-image-input-wrapper">
									...
									<div class="hover-cam mx-auto avatar circular-border overflow-hidden">
										<img src="{{ $avatar ? $avatar->temporaryUrl() : $settings["default-avatar"] }}" class="hover-zoom img-fluid avatar" id="avatar-file-container" alt="User Avatar" data-default-src="{{ $settings["default-avatar"] }}">
									...
									<input type="file" wire:model.lazy="avatar" name="avatar" class="d-none" accept=".jpg,.jpeg,.png,.webp" data-target-image-container="#avatar-file-container" data-target-name-container="#avatar-name" value="{{ $avatar ? $avatar->temporaryUrl() : null }}">
									<h6 id="avatar-name" class="text-truncate w-50 mx-auto" data-default-name="default.png">{{ $avatar ? $avatar->getClientOriginalName() : "default.png" }}</h6>
