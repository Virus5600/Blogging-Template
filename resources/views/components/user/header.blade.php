...
<div class="row mx-0">
	<div class="col-12 mx-0">
		<div class="w-100" id="carousel" data-image="{{ route('api.carousel.fetch') }}" data-sp="{{ asset('uploads/settings/carousel') }}" data-arrow="{{ asset('images/settings/carousel/arrow.png') }}" data-flex="true"></div>
